  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
        ...
        <Link to="/dashboard/analytics" className="no-underline flex h-full group">
          <div className="w-full min-h-[330px] flex flex-col justify-between p-7 bg-white border border-slate-200/90 rounded-2xl shadow-sm hover:shadow-xl hover:shadow-teal-500/10 hover:border-teal-300 transition-all duration-200 hover:-translate-y-1">
            <div>
              <div className="flex items-start justify-between mb-6">
                <div className="w-14 h-14 rounded-2xl bg-teal-50 border border-teal-100 text-teal-600 flex items-center justify-center shadow-md shadow-teal-500/10">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-2.5 group-hover:text-teal-600 transition-colors">
                Analytics & Reports
              </h2>
              <p className="text-sm text-slate-500 leading-relaxed">
            ...
            <div className="flex items-center justify-between pt-5 border-t border-slate-100 text-sm font-semibold text-teal-600 group-hover:text-teal-700">
              <span>Open Module</span>
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </div>
          </div>
